...
parser.add_argument('--MECsvPathTemplate', default='',
                    help='The path of csv files generated by ME. The case number in the path should be replaced by '
                         '@@i@@. For example,  "outputs/case@@i@@/metrics.csv" indicates that the ME csv files are '
                         'outputs/case0/metrics.csv, outputs/case1/metrics.csv, ... (default:"", which only works'
