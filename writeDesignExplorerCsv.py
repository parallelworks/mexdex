...
# Generate a csv file for Design Explorer (DE) from the input parameters and output
# metrics.
...
parser = argparse.ArgumentParser(
    description='Generate a csv file from result files for Design Explorer (DE)')
...
parser.add_argument("kpiFile",
                    help="The address of a json file used for specifying the output "
                         "metrics and images for Metrics Extraction (ME) Python library")
...
parser.add_argument('--includeOutputParamsFile', default='',
                    help='A file specifying the desired outputs to include as output '
                         'parameters in DE. By default all statistics specified in the '
                         'kpiFile are included as output parameters in DE')
...
parser.add_argument('--MECsvPathTemplate', default='',
                    help='The path of csv files generated by ME. The case number in the '
                         'path should be replaced by {:d}. For example,  '
                         '"outputs/case{:03d}/metrics.csv" indicates that the ME csv '
